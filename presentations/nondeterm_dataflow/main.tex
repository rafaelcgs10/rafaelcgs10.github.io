...
\begin{frame}[fragile]
  ...
  \begin{itemize}
    \item They have the same meaning!
    \item A small quirk: any corecursive call guarded by
the \isabelleinline{\const{Choice}} constructor must be applied using the map
function on \isabelleinline{\type{cset}}
  \end{itemize}
\end{frame}
