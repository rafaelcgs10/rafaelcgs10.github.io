...
\section{Introdução}
\label{sec:org93d8c64}
\begin{frame}[label={sec:org9ba0ac3}]{O que é cada coisa?}
\begin{itemize}
...
\section{Show of:}
\label{sec:org0d63aa9}
\begin{frame}[label={sec:orgfeda679}]{Show of:}
\begin{itemize}
...
\label{sec:org5245a9b}
\begin{frame}[label={sec:org626696a}]{Como usar Nix?}
\begin{itemize}
...
\label{sec:org2f020d3}
\begin{frame}[label={sec:orgeff58ef}]{Como usar Home Manager?}
\begin{itemize}
...
\label{sec:orga788d99}
\begin{frame}[label={sec:orgd522860}]{Como usar NixOS?}
\begin{itemize}
...
\label{sec:org6cadc28}
\begin{frame}[label={sec:org4cacd2e}]{Nix vs Docker}
\begin{itemize}
...
\label{sec:org2d05abc}
\begin{frame}[label={sec:org08d2b4d}]{Vantagems e desvantagens do NixOS}
\begin{itemize}
\item Vantagens:
\begin{enumerate}
...
\section{Conclusão}
\label{sec:org847273f}
\begin{frame}[label={sec:org25e7427}]{Conclusão}
\begin{itemize}
