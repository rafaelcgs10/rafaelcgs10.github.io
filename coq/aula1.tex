...
\section{Introducao}
\label{sec:org91fb7e7}

\begin{frame}[label={sec:org05b007b}]{Provadores Automáticos}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org42130eb}]{Assistentes de Provas}
\begin{itemize}
...
\begin{frame}[label={sec:orgdc9c957}]{Como Assistentes de provas assistem?}
\begin{itemize}
...
\begin{frame}[label={sec:org7487e89}]{Qual assistente utilizar?}
\begin{itemize}
...
\begin{frame}[label={sec:org394d47e}]{O que é Coq?}
\begin{itemize}
...
\begin{frame}[label={sec:org697c2f4}]{Programação certificada em Coq}
\begin{itemize}
...
\begin{frame}[label={sec:org66e0dab}]{Como aprender Coq?}
