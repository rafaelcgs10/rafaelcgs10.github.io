...
\begin{frame}[label={sec:orgf1b7f96}]{Como Assistentes de provas assistem?}
\begin{itemize}
...
\begin{frame}[label={sec:org82acf36}]{Qual assistente utilizar?}
\begin{itemize}
...
\begin{frame}[label={sec:org4ad2cb1}]{O que é Coq?}
\begin{itemize}
...
\begin{frame}[label={sec:org20e9645}]{Programação certificada em Coq}
\begin{itemize}
...
\begin{frame}[label={sec:org61d426a}]{Como aprender Coq?}
