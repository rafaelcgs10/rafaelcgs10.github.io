...
\section{Introducao}
\label{sec:org6d62f58}

\begin{frame}[label={sec:org5dd6c15}]{Provadores Automáticos}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orga1b5876}]{Assistentes de Provas}
\begin{itemize}
...
\begin{frame}[label={sec:orgd54ca49}]{Como Assistentes de provas assistem?}
\begin{itemize}
...
\begin{frame}[label={sec:org66efda0}]{Qual assistente utilizar?}
\begin{itemize}
...
\begin{frame}[label={sec:orgfd0881f}]{O que é Coq?}
\begin{itemize}
...
\begin{frame}[label={sec:org21f4ef5}]{Programação certificada em Coq}
\begin{itemize}
...
\begin{frame}[label={sec:org189cea5}]{Como aprender Coq?}
